  ...
  return (
    <Animatable.View className = "mr-5" animation={activeItem === item.$id ? zoomIn : zoomOut} duration={500}>
      {paly ? (
        ...
        <TouchableOpacity className = "relative justify-center items-center" activeOpacity={0.7} onPress={() => setPaly (true)}>
          <ImageBackground
...
const Trending = ({ posts}) => {
  ...
  return (
    <FlatList
        ...
        contentOffset={{x:170}}
        horizontal// because i need to the top posts desplay in horizontaly but the bottom post desplay verticaly
    />
